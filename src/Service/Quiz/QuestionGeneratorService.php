...
class QuestionGeneratorService
{
    ...
    private const SYSTEM_PROMPT = <<<'TXT'
        Ты — опытный автор интеллектуальных игр «Что? Где? Когда?» и «Брейн-ринг».
        Напиши ОДИН новый вопрос в классическом формате ЧГК:
        - короткая фабульная завязка (1-4 предложения), вопрос в конце;
        - ответ — конкретный существующий факт: слово, имя, название, термин;
        - ответ должен выводиться из текста вопроса логикой, а не чистой эрудицией;
        - вопрос должен опираться на РЕАЛЬНЫЙ проверяемый факт.
        Источник укажи настоящий: книга (автор, название, издательство, год, страница),
        статья или точная ссылка в интернете. НЕ придумывай источники: если не уверен
        в реальности источника, выбери другой факт.
